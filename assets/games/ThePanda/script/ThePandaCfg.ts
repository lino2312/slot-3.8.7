import { SlotGameTopBase } from "db://assets/scripts/game/slotgame/SlotGameTopBase";
import { ThePandaBottom } from "./ThePandaBottom";
import { ThePandaSlots } from "./ThePandaSlots";
import { SlotGameReelBase } from "db://assets/scripts/game/slotgame/SlotGameReelBase";
import { ThePandaSymbol } from "./ThePandaSymbol";

/**
 * 熊猫配置
 */
export const ThePandaCfg = {
    //符号配置(必须)
    symbol: {
    ...
    scripts: {
        Top: SlotGameTopBase,
        Bottom: ThePandaBottom,
        Slots: ThePandaSlots,
        Reels: SlotGameReelBase,
        Symbols: ThePandaSymbol,
    },
    //行列(必须)
    col: 5,
    row: 4,
